  ...
  if (trigger) {
    ...
    get(
      ...
      function (response) {
        ...
        console.log(
          `Map Swagger UI bundle file written to: '/public/doc/swagger-ui-bundle.js.map'`,
        );
      },
    );
    ...
    get(
      ...
      function (response) {
        ...
        console.log(
          `Map Swagger UI standalone preset file written to: '/public/doc/swagger-ui-standalone-preset.js.map'`,
        );
      },
    );
    ...
    get(`http://localhost:${port}/doc/swagger-ui.css.map`, function (response) {
      ...
      console.log(
        `Map Swagger UI css file written to: '/public/doc/swagger-ui.css.map'`,
      );
    });
